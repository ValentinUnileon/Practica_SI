...
public class Nomina  implements java.io.Serializable {
     ...
     private double fogasAempresiario;
    ...
    public Nomina(int idNomina, int mes, int anio, int numeroTrienios, double importeTrienios, double importeSalarioMes, double importeComplementoMes, double valorProrrateo, double brutoAnual, double irpf, double importeIrpf, double baseEmpresario, String seguridadSocialEmpresario, double importeSeguridadSocialEmpresario, double desempleoEmpresario, double importeDesempleoEmpresario, double formacionEmpresario, double importeFormacionEmpresario, double accidentesTrabajoEmpresario, double importeAccidentesTrabajoEmpresario, double fogasAempresiario, double importeFogasaempresario, double seguridadSocialTrabajador, double importeSeguridadSocialTrabajador, double desempleoTrabajador, double importeDesempleoTrabajador, double formacionTrabajador, double importeFormacionTrabajador, double brutoNomina, double liquidoNomina, double costeTotalEmpresario, int diasBaja, double importeDescuentoBaja, int trabajadorIdTrabajador) {
       ...
       this.fogasAempresiario = fogasAempresiario;
    ...
    public double getFogasAempresiario() {
        return this.fogasAempresiario;
    }
    
    public void setFogasAempresiario(double fogasAempresiario) {
        this.fogasAempresiario = fogasAempresiario;
    }
    ...
    public int getTrabajadorIdTrabajador() {
        return this.trabajadorIdTrabajador;
    }
